...
namespace ns_PokeCount
{
    static class Log
    {
        public static void LoadLog(PokeCount target, ref PokeMenu[] userControls, string result_folder_path, int max_control_num)
        {
        ...
        public static void SaveLog(PokeCount target, ref PokeMenu[] user_controls, string result_folder_path)
        {
